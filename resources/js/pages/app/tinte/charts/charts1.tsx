        ...
        <Card className="lg:max-w-md" x-chunk="charts-01-chunk-0">
          <CardHeader className="space-y-0 pb-2">
            ...
            <CardTitle className="text-4xl tabular-nums">
              12,584 <span className="text-muted-foreground font-sans text-sm font-normal tracking-normal">steps</span>
            </CardTitle>
          </CardHeader>
          <CardContent>
            <ChartContainer
          ...
          <CardFooter className="flex-col items-start gap-1">
            <CardDescription>
              Over the past 7 days, you have walked <span className="text-foreground font-medium">53,305</span> steps.
            </CardDescription>
            <CardDescription>
              You need <span className="text-foreground font-medium">12,584</span> more steps to reach your goal.
            </CardDescription>
          </CardFooter>
        </Card>
          ...
          <CardHeader className="flex flex-row items-center gap-4 space-y-0 pb-2 [&>div]:flex-1">
            <div>
              ...
              <CardTitle className="flex items-baseline gap-1 text-4xl tabular-nums">
                62
                <span className="text-muted-foreground text-sm font-normal tracking-normal">bpm</span>
              </CardTitle>
            </div>
            <div>
              ...
              <CardTitle className="flex items-baseline gap-1 text-4xl tabular-nums">
                35
                <span className="text-muted-foreground text-sm font-normal tracking-normal">ms</span>
              </CardTitle>
            </div>
          </CardHeader>
          ...
          <CardContent className="grid gap-4">
            <div className="grid auto-rows-min gap-2">
              <div className="flex items-baseline gap-1 text-2xl leading-none font-bold tabular-nums">
                12,453
                <span className="text-muted-foreground text-sm font-normal">steps/day</span>
              </div>
              <ChartContainer
                config={{
                  steps: {
        ...
        <Card className="max-w-xs" x-chunk="charts-01-chunk-3">
          ...
          <CardContent className="flex flex-row items-baseline gap-4 p-4 pt-0">
            <div className="flex items-baseline gap-1 text-3xl leading-none font-bold tabular-nums">
              12.5
              <span className="text-muted-foreground text-sm font-normal">miles/day</span>
            </div>
            <ChartContainer
              config={{
                steps: {
      ...
      <div className="grid w-full flex-1 gap-6">
        ...
        <Card className="max-w-xs" x-chunk="charts-01-chunk-6">
          ...
          <CardContent className="flex flex-row items-baseline gap-4 p-4 pt-2">
            <div className="flex items-baseline gap-2 text-3xl leading-none font-bold tabular-nums">
              1,254
              <span className="text-muted-foreground text-sm font-normal">kcal/day</span>
            </div>
            <ChartContainer
              config={{
                calories: {
        ...
        <Card className="max-w-xs" x-chunk="charts-01-chunk-7">
          <CardHeader className="space-y-0 pb-0">
            ...
            <CardTitle className="flex items-baseline gap-1 text-4xl tabular-nums">
              8<span className="text-muted-foreground font-sans text-sm font-normal tracking-normal">hr</span>
              35
              <span className="text-muted-foreground font-sans text-sm font-normal tracking-normal">min</span>
            </CardTitle>
          </CardHeader>
