        ...
        <div className="sticky bottom-0 mt-10">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Need more pages and components? Then you can get the pro.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              <Button size="sm" className="w-full items-center bg-gradient-to-r from-indigo-700 via-purple-500 to-pink-700 hover:opacity-90" asChild>
