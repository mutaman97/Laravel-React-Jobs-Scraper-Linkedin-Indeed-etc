...
const TimeSpentExercising = ({ className, ...props }: Props) => {
  ...
  return (
    <Card className={cn('flex h-[356px] flex-col justify-between px-4', className)} {...props}>
      ...
      <Chart type="line" height={270} options={chartOptions} series={chartSeries} width="100%" />
    </Card>
  )
}
