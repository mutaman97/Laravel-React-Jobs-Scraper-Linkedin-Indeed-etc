...
const Page = () => {
  return (
    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-14">
      ...
      <ComponentViewer title="Sales Section" Component={Sales} componentPath="src/components/dashboard/ecommerce/sales.tsx" />
      ...
      <ComponentViewer title="RecentOrders Section" Component={RecentOrders} componentPath="src/components/dashboard/ecommerce/recent-orders.tsx" />

      <ComponentViewer title="TopSeller Section" Component={TopSeller} componentPath="src/components/dashboard/ecommerce/top-seller.tsx" />
